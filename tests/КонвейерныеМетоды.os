...
Функция ПолучитьСписокТестов(ЮнитТестирование) Экспорт
	...
	ВсеТесты.Добавить("ТестДолжен_ОтфильтроватьЭлементыСПростымИспользованиемПараметров");
	ВсеТесты.Добавить("ТестДолжен_ОтфильтроватьЭлементыБезИспользованияРезультата");
...
Процедура ТестДолжен_ОтфильтроватьЭлементыСПростымИспользованиемПараметров() Экспорт
	...
	Результат = ПроцессорКоллекций
		...
		.ВМассив();
	Для Каждого Элемент Из Результат Цикл
		Ожидаем.Что(Элемент).Меньше(МаксимальноеЗначение);
	КонецЦикла;
КонецПроцедуры
