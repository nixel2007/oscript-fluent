...
Процедура ВыполнитьРазличные(Результат, ДополнительныеПараметры) Экспорт
	...
	Для Каждого Элемент Из Коллекция Цикл
		// Лог.Отладка("Различные - проверяю %1", Элемент);
		...
		Для Каждого ЭлементРезультат Из Результат Цикл
			...
			// Лог.Отладка("Различные - результат сравнения %1, Элемент1 %2, Элемент2 %3",
			// 	РезультатСравнения, Элемент, ЭлементРезультат);
		...
		Если КоличествоСовпадений = 0 Тогда
			Результат.Добавить(Элемент);
			// Лог.Отладка("Различные - добавлен в результат %1", Элемент);
		КонецЕсли;
