...
Функция Обработчик_ФильтрацияПоМестоположению(ДополнительныеПараметры) Экспорт
	РезультатФильтрации = ДополнительныеПараметры.Элемент.Местоположение = "Россия";
	Возврат РезультатФильтрации;
КонецФункции

Функция Обработчик_СортировкаПоФолловерам(ДополнительныеПараметры) Экспорт
...
Функция Обработчик_СортировкаПоКонтрибьюциям(ДополнительныеПараметры) Экспорт
	РезультатСравнения = ДополнительныеПараметры.Элемент1.Контрибьюции < ДополнительныеПараметры.Элемент2.Контрибьюции;
	Возврат РезультатСравнения;
КонецФункции

ФильтрацияПоМестоположению = Делегаты.Создать(ЭтотОбъект, "Обработчик_ФильтрацияПоМестоположению");
СортировкаПоФолловерам = Делегаты.Создать(ЭтотОбъект, "Обработчик_СортировкаПоФолловерам");
СортировкаПоКонтрибьюциям = Делегаты.Создать(ЭтотОбъект, "Обработчик_СортировкаПоКонтрибьюциям");
