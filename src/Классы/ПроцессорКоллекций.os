...
//
// Параметры:
//   ФункцияРавенства - Строка, ОписаниеОповещения - Функция равенства.
...
//				Если возвращается Истина, элементы равны, иначе неравны.
...
Функция Различные(Знач ФункцияРавенства = Неопределено, Знач ДополнительныеПараметры = Неопределено) Экспорт
	...
	Если ФункцияРавенства = Неопределено Тогда
		ФункцияРавенства = ПроцессорыКоллекций.СтандартнаяФункцияРавенства();
	Иначе
		Если ТипЗнч(ФункцияРавенства) = Тип("Строка") Тогда
			ФункцияРавенства = СформироватьВременноеОписаниеОповещения(ФункцияРавенства, ДополнительныеПараметры);
		КонецЕсли;
	КонецЕсли;
	ДополнитьСтруктуру(ФункцияРавенства.ДополнительныеПараметры, ДополнительныеПараметры, Истина);

	ПоложитьЯчейкуВКонвейер("Различные", ФункцияРавенства);
	Возврат ЭтотОбъект;
